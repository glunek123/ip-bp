...
- [x] **Step 2: Run the migration spec and observe RED**
...
- [x] **Step 3: Add the Prisma model and forward SQL migration**
...
- [x] **Step 4: Generate Prisma and run the migration spec GREEN**
...
- [x] **Step 2: Run auth tests and observe RED**
...
- [x] **Step 3: Implement discriminated session resolution**
...
- [x] **Step 4: Run backend and frontend auth tests GREEN**
...
- [x] **Step 5: Commit real client authentication**
...
- [x] **Step 1: Write failing service/controller/API/component tests**
...
- [x] **Step 3: Implement atomic account creation and status management**
...
- [x] **Step 4: Implement the customer detail panel**
...
- [x] **Step 1: Write failing push tests**
...
- [x] **Step 2: Run lead tests and observe RED**
...
- [x] **Step 3: Implement authorization and command**
...
- [x] **Step 4: Run lead tests GREEN and commit**
...
- [x] **Step 2: Run client lead/material tests and observe RED**
...
- [x] **Step 3: Implement client query projection and material branch**
...
- [x] **Step 1: Write failing router, shell and login tests**
...
- [x] **Step 3: Implement audience-aware UI routing**
...
- [x] **Step 3: Implement the operation and client UI**
...
- [x] **Step 1: Add database/browser tests before production adjustments**
...
- [x] **Step 2: Run database acceptance and observe any RED caused by missing integration**
...
- [x] **Step 1: Perform an isolated full-diff review before expensive gates**
...
- [x] **Step 2: Run migration acceptance**
...
- [x] **Step 3: Freeze a clean candidate and run formal Level 3 gates**
...
- [x] **Step 4: Update completion sources only after evidence exists**
...
- [x] **Step 5: Record and strictly verify context**

Run: `pnpm context:record && pnpm context:check:strict`

Expected: PASS.

- [x] **Step 6: Commit final documentation and report status**
