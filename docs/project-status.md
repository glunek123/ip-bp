...
**CORE-NT-002｜开箱材料（路线图唯一Current，待领取）**：CORE-NT-001固定候选`0597388`已完成线上取证物流并通过完整Level 3门禁；CORE-NT-003为唯一Next。下一任务先核对已批准开箱字段、附件和身份范围，再领取并实施；不把NT-001的完成扩大为后续公证阶段。
